...
public class OCLExpressionsPrettyPrinter extends OCLExpressionsPrettyPrinterTOP {
    ...
    // The following overriden methods are required, as the auto generation of pretty printers failed here

    @Override
    public void handle(de.monticore.ocl.oclexpressions._ast.ASTInDeclaration node) {
        ...
        Iterator<ASTInDeclarationVariable> astInDeclarationIterator = node.iteratorInDeclarationVariables();

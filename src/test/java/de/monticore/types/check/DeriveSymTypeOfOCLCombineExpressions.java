...
public class DeriveSymTypeOfOCLCombineExpressions
  ...
  private TestOCLExpressionsDelegatorVisitor realThis;
  ...
  private DeriveSymTypeOfTestOCLExpressions deriveSymTypeOfTestOCLExpressions;
  ...
  public DeriveSymTypeOfOCLCombineExpressions(IExpressionsBasisScope scope) {
    ...
    deriveSymTypeOfTestOCLExpressions = new DeriveSymTypeOfTestOCLExpressions();
    deriveSymTypeOfTestOCLExpressions.setLastResult(lastResult);
    setTestOCLExpressionsVisitor(deriveSymTypeOfTestOCLExpressions);
  ...
  @Override
  public TestOCLExpressionsDelegatorVisitor getRealThis() {
    return realThis;
  }

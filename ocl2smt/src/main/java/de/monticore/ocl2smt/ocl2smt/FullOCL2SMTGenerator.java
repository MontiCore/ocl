...
public class FullOCL2SMTGenerator {
  ...
  private final Context ctx;
        ...
        protected Expr<? extends Sort> convertCtxParDec(ASTOCLParamDeclaration node) {
            ...
            Expr<? extends Sort> obj = fullExprConv.declVariable(oclType, node.getName());
            fullExprConv.setOCLContext(obj, oclType);
            return obj;
        }
        ...
        private BoolExpr convertPreCond(ASTOCLOperationConstraint node, FullOCLExpressionConverter opConverter) {
        ...
        public OPConstraint convertOpConst(ASTOCLOperationConstraint node) {
            ...
            openOpScope(node.getOCLOperationSignature(),fullExprConv);
        ...
        public OCLOPWitness buildOPOd(
            ...
            assert od.isPresent();
            return OCL2SMTStrategy.splitPreOD(method, od.get(), model, fullExprConv.getConstrData());
        }

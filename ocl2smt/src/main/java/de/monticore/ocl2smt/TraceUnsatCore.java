...
public class TraceUnsatCore {
    ...
    protected static ASTODArtifact buildUnsatOD(List<IdentifiableBoolExpr> posConstraints, List<IdentifiableBoolExpr> negConstraints, List<ASTODLink> unsatCore) {

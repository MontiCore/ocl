...
public class CommonExpressionTest extends ExpressionAbstractTest {
  ...
  public void testLogicExpressionConverter() {
    Assertions.assertEquals(res.get(0), ocl2SMTGenerator.getCD2SMTGenerator().getContext().mkBool(true));
    Assertions.assertEquals(res.get(1), ocl2SMTGenerator.getCD2SMTGenerator().getContext().mkFalse());
